...
public final class SampleActivity extends Activity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    stegosaurusView.setText(stegosaurus.name + " is " + stegosaurus.length_meters + " meters long!");
    tyrannosaurusView.setText(tyrannosaurus.name + " weighs " + tyrannosaurus.mass_kilograms + " kilos!");
  }
}
